...
Matriz* matriz_OEF1_01(Matriz* matriz, int nro_fila, int escalar) {
    M E1 = matriz_elemental1(matriz->nro_filas, nro_fila, escalar);
    M resultado = matriz_mult(E1, matriz);
...
Matriz* matriz_OEF2_01(Matriz* matriz, int fila_origen, int fila_destino, int escalar) {
    M E2 = matriz_elemental2(matriz->nro_filas, fila_origen, fila_destino, escalar);
    M resultado = matriz_mult(E2, matriz);
...
Matriz* matriz_ERF_asociada(Matriz* matriz) {

    M ERF_asociada = matriz_copiar(matriz);
